...
A Chrome extension (Manifest V3) that monitors Upwork job postings you've applied to. It reloads tracked job tabs on a schedule, reads the **Last viewed by client** timestamp, and sends a desktop notification the moment the client views your proposal more recently than before.
